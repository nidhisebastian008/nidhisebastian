/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-7218e13301017c4c44d8.js.LICENSE.txt */
  ...
  [98],
  {
    ...
    5414: function (e, t, n) {
      ...
      var r,
        ...
        R = 'titleTemplate',
        _ = Object.keys(M).reduce(function (e, t) {
          return (e[M[t]] = t), e;
        }, {}),
              ...
              n.filter(function (e) {
                for (var n = void 0, a = Object.keys(e), o = 0; o < a.length; o++) {
                  ...
                  -1 === t.indexOf(l) ||
                    ...
                    (l === A && 'stylesheet' === e[l].toLowerCase()) ||
                    (n = l),
        ...
        pe = u()(
          function (e) {
            return {
              ...
              linkTags: J(y.LINK, [A, E], e),
              metaTags: J(y.META, [T, x, k, O, S], e),
              noscriptTags: J(y.NOSCRIPT, [C], e),
              onChangeClientState: G(e),
              scriptTags: J(y.SCRIPT, [L, C], e),
              ...
              var u,
                ...
                p = {
                  cancelScroll: function (e) {
                    cancelAnimationFrame(m), (m = null), e || s('scrollCancel', u);
                  },
                  animateScroll: function (r, l, c) {
                    ...
                    if (h || g) {
                      ...
                      var b,
                        ...
                        M =
                          ((b = A),
                          (x = (y = d).speedAsDuration ? y.speed : Math.abs((b / 1e3) * y.speed)),
                          y.durationMax && x > y.durationMax
                            ? y.durationMax
                            : y.durationMin && x < y.durationMin
                            ? y.durationMin
                            : parseInt(x, 10)),
                        I = function t(n) {
                          var i, a, c;
                          w || (w = n),
                            ...
                            (function (t, n) {
                              var i = e.pageYOffset;
                              if (t == n || i == n || (v < n && e.innerHeight + i) >= L)
                                return (
                                  p.cancelScroll(!0),
                                  o(r, n, h),
                                  s('scrollStop', d, r, l),
      ...
      var r = n(7294),
        ...
        h = function () {
          return r.createElement(
            ...
            r.createElement(
              'text',
              { x: '26', y: '65', fill: 'currentColor', fontSize: '50px', fontFamily: 'Consolas' },
              'N',
            ),
          );
        },
    ...
    5733: function (e, t, n) {
      ...
      var r = n(7294),
        ...
        s = function (e) {
          var t = e.title,
            ...
            m = c.defaultImage,
            p = c.twitterUsername,
            h = { title: t || u, description: n || d, image: '' + f + (s || m), url: '' + f + l };
          return r.createElement(
            i.q,
      ...
      var j = {
        ...
        key: function (e) {
          return (
            !O.hasOwnProperty(e) && !A.hasOwnProperty(e) && 'targets' !== e && 'keyframes' !== e
          );
        },
      };
      function P(e) {
      ...
      function R(e, t) {
        var n = P(e),
          r = M(j.und(n[0]) ? 1 : n[0], 0.1, 100),
          i = M(j.und(n[1]) ? 100 : n[1], 0.1, 100),
          a = M(j.und(n[2]) ? 10 : n[2], 0.1, 100),
          o = M(j.und(n[3]) ? 0 : n[3], 0.1, 100),
          s = Math.sqrt(i / r),
          l = a / (2 * Math.sqrt(i * r)),
      ...
      function $(e, t) {
        var n = G(e);
        for (var r in t) n[r] = j.und(e[r]) ? t[r] : e[r];
        return n;
      }
      function J(e) {
        return j.rgb(e)
      ...
      function re(e, t) {
        return j.dom(e) && !j.inp(e) && (!j.nil(ee(e, t)) || (j.svg(e) && e[t]))
          ? 'attribute'
          : j.dom(e) && V(L, t)
          ? 'transform'
          : j.dom(e) && 'transform' !== t && ne(e, t)
          ? 'css'
          : null != e[t]
          ? 'object'
          : void 0;
      ...
      function fe(e, t) {
        var n = t || {},
          r =
            n.el ||
            (function (e) {
              for (var t = e.parentNode; j.svg(t) && j.svg(t.parentNode); ) t = t.parentNode;
              return t;
            })(e),
      ...
      function pe(e, t) {
        var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
          r = le(j.pth(e) ? e.totalLength : e, t) + '';
        return {
          original: r,
          numbers: r.match(n) ? r.match(n).map(Number) : [0],
          strings: j.str(e) || t ? r.split(n) : [],
        };
      }
      function he(e) {
        return Z(e ? Y(j.arr(e) ? e.map(U) : U(e)) : [], function (e, t, n) {
      ...
      function ve(e, t) {
        var n = G(t);
        if ((/^spring/.test(n.easing) && (n.duration = R(n.easing)), j.arr(e))) {
          var r = e.length;
          2 === r && !j.obj(e[0])
            ? (e = { value: e })
            : j.fnc(t.duration) || (n.duration = t.duration / r);
        }
        var i = j.arr(e) ? e : [e];
        return i
          .map(function (e, n) {
            var r = j.obj(e) && !j.pth(e) ? e : { value: e };
            return (
              j.und(r.delay) && (r.delay = n ? 0 : t.delay),
              j.und(r.endDelay) && (r.endDelay = n === i.length - 1 ? t.endDelay : 0),
              r
            );
          })
          .map(function (e) {
      ...
      function be(e, t) {
                ...
                var t = Z(
                  ...
                  r = function (r) {
                    ...
                    n[i] = e.map(function (e) {
                      var t = {};
                      for (var n in e) j.key(n) ? n == i && (t.value = e[n]) : (t[n] = e[n]);
                      return t;
                    });
                  },
                  i = 0;
        ...
        t))
          j.key(i) && n.push({ name: i, tweens: ve(t[i], e) });
        return n;
      }
      function ye(e, t) {
        var n;
        return e.tweens.map(function (r) {
          ...
          return (
            ...
            (i.isPath = j.pth(a)),
            (i.isPathTargetInsideSVG = i.isPath && j.svg(t.target)),
            (i.isColor = j.col(i.from.original)),
            i.isColor && (i.round = 1),
            (n = i),
            i
          );
      ...
      var Se = [],
        Te = (function () {
          ...
          return (
            ...
            function () {
              e ||
                (Oe() && Ae.suspendWhenDocumentHidden) ||
                !(Se.length > 0) ||
      ...
      function Ae(e) {
        ...
        function d() {
          (n = 0), (r = u(l.currentTime) * (1 / Ae.speed));
        }
        function f(e, t) {
        ...
        function m(e) {
          for (var t = 0, n = l.animations, r = n.length; t < r; ) {
            ...
            for (
              ...
              (b = c.isPath ? me(c.value, d * y, c.isPathTargetInsideSVG) : x + d * (y - x)),
            ...
            xe[i.type](a.target, i.property, g, a.transforms), (i.currentValue = g), t++;
          }
        }
        function p(e) {
        ...
        return (
          ...
          (l.play = function () {
            l.paused && (l.completed && l.reset(), (l.paused = !1), Se.push(l), d(), Te());
          }),
          (l.reverse = function () {
          ...
          return (
            ...
            (t.add = function (n, r) {
              ...
              (l.autoplay = !1),
                ...
                (l.timelineOffset = j.und(r) ? c : se(r, c)),
                o(t),
      ...
      var Me = Ae,
        ...
        je = function (e) {
          ...
          return (
            (0, r.useEffect)(function () {
              ...
              return (
                Me.timeline({
                  ...
                  .add({ targets: '#logo #N', duration: 700, easing: 'easeInOutQuart', opacity: 1 })
                  .add({
                    targets: '#logo',
                    delay: 500,
                    duration: 300,
            ...
            r.createElement(
              ...
              r.createElement('div', { className: 'logo-wrapper' }, r.createElement(Ie.pA, null)),
            )
          );
        },
        Pe = n(5813),
              ...
              l
                ...
                : r.createElement(
                    ...
                    o &&
                      r.createElement(
                        Re.Z,
                        { classNames: n ? 'fade' : '', timeout: n ? De.Cs : 0 },
                        t,
                      ),
                  ),
            )
        ...
        Xe = c.default.div.withConfig({
          ...
          "display:flex;flex-direction:column;align-items:center;position:relative;&:after{content:'';display:block;width:1px;height:300px;margin:0 auto;background-color:var(--light-slate);}a{margin:20px auto;padding:10px;font-family:var(--font-mono);font-size:var(--fz-xs);letter-spacing:0.1em;writing-mode:vertical-rl;&:hover,&:focus{transform:translateY(-3px);}}",
        ]),
        et = function (e) {
          var t = e.isHome;
          return r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement('p', null, 'Revised by Nidhi Sebastian'),
                  ),
                  t.stars &&
                    t.forks &&
                    r.createElement(
                      ...
                      r.createElement(
                        'span',
                        null,
                        r.createElement(Ie.JO, { name: 'Star' }),
                        r.createElement('span', null, t.stars.toLocaleString()),
                      ),
                      r.createElement(
                        'span',
                        null,
                        r.createElement(Ie.JO, { name: 'Fork' }),
        ...
        at = c.default.section.withConfig({
          ...
          [
            '',
            ';flex-direction:column;align-items:flex-start;min-height:100vh;padding:0;@media (max-width:480px) and (min-height:700px){padding-bottom:10vh;}h1{margin:35px 0 30px 4px;color:var(--green);font-family:var(--font-mono);font-size:clamp(var(--fz-sm),5vw,var(--fz-md));font-weight:400;@media (max-width:480px){margin:0 0 20px 2px;}}h3{margin-top:10px;color:var(--slate);line-height:0.9;}p{margin:20px 0 0;max-width:540px;}.email-link{',
            ';margin-top:50px;}',
          ],
          function (e) {
            return e.theme.mixins.flexCenter;
        ...
        ot = function () {
          ...
          var a = [
            ...
            r.createElement('h2', { className: 'big-heading' }, 'Nidhi Anne Sebastian'),
            r.createElement(
              r.Fragment,
              null,
              r.createElement(
                ...
                r.createElement(
                  'a',
                  { href: 'https://www.natwestgroup.com//', target: '_blank', rel: 'noreferrer' },
                  'Natwest Group',
                ),
                ' ',
              ...
              r.createElement(
                'p',
                null,
                'I am a keen learner and take up challenges that come my way and try to give the best of myself to my work.',
              ),
              r.createElement(
                'p',
                null,
                'Apart from that , I love to dance ,also professionally trained in Bharatnatyam and Kathak. Yoga , mediation and keeping fit is my hobby.',
              ),
            ),
            r.createElement(
              'a',
              ...
              : r.createElement(
                  ...
                  t &&
                    a.map(function (e, t) {
                      return r.createElement(
                        Re.Z,
                        { key: t, classNames: 'fadeup', timeout: De.Cs },
        ...
        ft = function () {
          var e = (0, r.useRef)(null),
            t = (0, Fe.Tb)();
          (0, r.useEffect)(function () {
            t || lt.Z.reveal(e.current, (0, _e.srConfig)());
          }, []);
          var n = ['Java', 'Python', 'Django', 'Git', 'Maven'];
          return r.createElement(
            ct,
            { id: 'about', ref: e },
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'p',
                    null,
                    'Hello! I am nidhi, I graduated in 2020 from Maharaja Agrasen Institute of Technology in Bachelors in Technology in Computer Science and Engineering!',
                  ),
                  r.createElement(
                    'p',
                    null,
                    'Thereafter ,I worked at ',
                    r.createElement(
                      'a',
                    ...
                    ' ',
                    'where I worked on automations and monitoring tools using Python and Django . Currently, working at ',
                    r.createElement(
                      'a',
                    ...
                    ' ',
                    'currently working with Java Enterprise applications, in the payments domain of the bank.',
                  ),
                  r.createElement(
                    'p',
                    null,
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(st.S, {
                    ...
                    alt: 'Headshot',
                    __error:
                      'No data found for image "/home/nidhi/Documents/portfolio-page/v4/src/images/IMG-20200223-WA0082.jpg"\n              undefinedCould not read image data file "/home/nidhi/Documents/portfolio-page/v4/.cache/caches/gatsby-plugin-image/2683222030.json". \nThis may mean that the images in "/home/nidhi/Documents/portfolio-page/v4/src/components/sections/about.js" were not processed.\nPlease ensure that your gatsby version is at least 2.24.78.',
                  }),
                ),
              ),
            ),
        ...
        yt = function () {
          var e = (0, o.useStaticQuery)('604461682').jobs.edges,
            ...
            d = (0, Fe.Tb)();
          (0, r.useEffect)(function () {
            d || lt.Z.reveal(u.current, (0, _e.srConfig)());
          }, []);
          (0, r.useEffect)(
            function () {
              c.current[s]
        ...
        xt = c.default.section.withConfig({
    ...
    537: function (e) {
      e.exports = {
        email: 'nidhiseb@gmail.com',
        socialMedia: [
          { name: 'GitHub', url: 'https://github.com/nidhisebastian008' },
          { name: 'Instagram', url: 'https://www.instagram.com/sebastiannidhi' },
          { name: 'Linkedin', url: 'https://www.linkedin.com/in/nidhi-sebastian-6a5b91166/' },
        ],
        navLinks: [
    ...
    355: function (e, t, n) {
      ...
      function E(e) {
        ...
        if (g.generated || k.generated.initial) {
          ...
          g.generated &&
            S.fragments.push({
              delayed: 'opacity ' + O / 1e3 + 's ' + A + ' ' + T / 1e3 + 's',
              instant: 'opacity ' + O / 1e3 + 's ' + A + ' 0s',
            }),
            k.generated.initial &&
              S.fragments.push({
                delayed: k.property + ' ' + O / 1e3 + 's ' + A + ' ' + T / 1e3 + 's',
                instant: k.property + ' ' + O / 1e3 + 's ' + A + ' 0s',
              }),
            S.computed &&
      ...
      function M(e, t) {
        ...
        return t.reveal || i ? I.call(this, e, r) : t.reset || a ? z.call(this, e) : void 0;
      }
      function I(e, t) {
        var n = [
          ...
          if (((n.models = { visible: i, revealed: a }), !a.body.length)) {
            ...
            if (s)
              return (
                ...
                D.call(this, n, i.body[0], 1, t),
                M.call(this, s, { reveal: !0, pristine: t })
              );
          }
          if (!n.blocked.head && r === [].concat(a.head).pop() && r >= [].concat(i.body).shift())
            return D.call(this, n, r, -1, t), M.call(this, e, { reveal: !0, pristine: t });
      ...
      function F(e, t, n) {
        ...
        try {
          ...
          var c = l.reduce(function (e, n) {
            ...
            l
              ? (T(s, r.store.elements[l]), k(s.node, s.styles.inline.computed))
              : ((s.id = L()), (s.node = n), (s.seen = !1), (s.revealed = !1), (s.visible = !1));
            var c = T({}, s.config || r.defaults, t);
            if ((!c.mobile && O()) || (!c.desktop && !O())) return l && C.call(r, s), e;
            var u,
              d = a(c.container)[0];
        ...
        void 0 === e && (e = { type: 'init' }),
          ...
          p(function () {
            ...
            b(n.store.containers, function (e) {
              ...
              b(t, function (e) {
                e.sequence ? P.call(n, e) : M.call(n, e);
              }),
              (n.pristine = !1);
          });
      }
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-7218e13301017c4c44d8.js.map
