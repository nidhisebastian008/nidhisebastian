/*! For license information please see app-0aef03d591b23d496c54.js.LICENSE.txt */
(self.webpackChunkv4 = self.webpackChunkv4 || []).push([
  [143],
  {
    ...
    4041: function () {
      ...
      var a = (function () {
          function e() {
            for (var t = this, n = arguments.length, r = Array(n), a = 0; a < n; a++)
              r[a] = arguments[a];
            return (
              o(this, e),
              (this.tag = function (e) {
    ...
    9: function (e, t, n) {
      ...
      var s = function (e) {
          function t(e, r, c, u, p) {
              ...
              if (
                ...
                switch (h) {
                  case 123:
                    ...
                    (H += m), (m = U = N = I = d = 0), (z = ''), (h = c.charCodeAt(++M));
                    break;
                  case 125:
                  case 59:
              ...
              switch (h) {
                ...
                case 10:
                  47 === C
                    ...
                    0 < T * D && s(0, z, r, e, _, R, $.length, u, p, u),
                    (R = 1),
                    _++;
                  break;
                case 59:
            ...
            if (0 < (W = $.length)) {
              if (
                ((N = r),
                0 < T && void 0 !== (w = s(2, $, N, e, _, R, W, u, p, u)) && 0 === ($ = w).length)
              )
                return G + $ + H;
              if ((($ = N.join(',') + '{' + $ + '}'), 0 != O * A)) {
          ...
          function a(e, t) {
            ...
            return (
              (n = e.substring(n + 1, e.length - 1)), I(2 !== t ? r : r.replace(P, '$1'), n, t)
            );
          }
          function i(e, t) {
          ...
          function s(e, t, n, r, o, a, i, s, c, l) {
            for (var f, p = 0, d = t; p < T; ++p)
              switch ((f = L[p].call(u, e, d, n, r, o, a, i, s, c, l))) {
                case void 0:
                case !1:
                case !0:
                case null:
          ...
          function u(e, n) {
            ...
            var a = t(j, r, n, 0, 0);
            return (
              0 < T && void 0 !== (o = s(-2, a, r, r, _, R, a.length, 0, 0, 0)) && (a = o),
              '',
              (A = 0),
              (R = _ = 1),
              a
      ...
      var R = (function () {
        ...
        I = 'style[' + S + '][data-styled-version="5.3.1"]',
      ...
      function De(e, t, n) {
        ...
        r &&
          ...
          (k = t.shouldForwardProp
            ...
            : e.shouldForwardProp);
        var C,
          P = new X(n, m, r ? e.componentStyle : void 0),
      ...
      function Ue(e) {
        ...
        function u(e, t, n, r, o) {
          if (s.isStatic) s.renderStyles(e, E, n, o);
            ...
            var a = d({}, t, { theme: Se(t, r, c.defaultProps) });
    ...
    5182: function (e, t, n) {
      e.exports = [
        ...
        { plugin: n(6988), options: { plugins: [] } },
        {
          ...
          options: {
            plugins: [],
            name: 'Nidhi Sebastian',
            short_name: 'Nidhi Sebastian',
            start_url: '/',
            ...
            include_favicon: !0,
            cacheDigest: '2349ae4764064438f4824793bf3bd0d2',
          },
        },
    ...
    2359: function (e, t, n) {
      ...
      var g,
        ...
        b = function (e) {
          var t = e.children,
            n = u(e, v);
          return r.createElement(r.Fragment, null, r.createElement(y, s({}, n)), t, !1);
        },
        ...
        C = (0, r.forwardRef)(function (e, t) {
          var n = e.fallback,
            ...
            p = r.createElement(k, s({}, l, n, { sizes: f, shouldLoad: c, innerRef: t }));
          return a.length
            ? r.createElement(
                'picture',
                null,
      ...
      var P = ['fallback'],
        E = function (e) {
          var t = e.fallback,
            n = u(e, P);
          return t
            ? r.createElement(C, s({}, n, { fallback: { src: t }, 'aria-hidden': !0, alt: '' }))
            : r.createElement('div', s({}, n));
        };
      (E.displayName = 'Placeholder'),
        (E.propTypes = {
          fallback: o.string,
          sources: null == (g = C.propTypes) ? void 0 : g.sources,
          alt: function (e, t, n) {
            return e[t]
      ...
      var x = (0, r.forwardRef)(function (e, t) {
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(C, s({ ref: t }, e)),
          r.createElement('noscript', null, r.createElement(C, s({}, e, { shouldLoad: !0 }))),
        );
      });
      (x.displayName = 'MainImage'), (x.propTypes = C.propTypes);
      var R = function (e, t, n) {
        ...
        _ = { image: a().object.isRequired, alt: R },
        A = ['style', 'className'],
        O = (function (e) {
          var t, o;
          function a(t) {
        ...
        j = function (e) {
          ...
          return r.createElement(O, s({ key: n }, e));
        };
      (j.propTypes = _), (j.displayName = 'GatsbyImage');
      var L,
        T = [
          'src',
          '__imageData',
        ...
        M = {
          ...
          sizes: a().string,
          layout: function (e) {
            if (void 0 !== e.layout && !D.has(e.layout))
              return new Error(
                'Invalid value ' +
                  e.layout +
    ...
    9499: function (e, t, n) {
      ...
      var M = function (e) {
        ...
        N = L('Base', { baseuri: '/', basepath: '/', navigate: E.navigate }),
        U = function (e) {
...
//# sourceMappingURL=app-0aef03d591b23d496c54.js.map
